...
public class BoosterIgnorList extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.ignorList.addOnItemTouchListener(new RecyclerTouchListener(this.context, this.ignorList, new ClickListener() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.BoosterIgnorList.AnonymousClass1 */

            @Override // com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.BoosterIgnorList.ClickListener
    ...
    static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ClickListener clickListener2) {
            ...
            this.gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
                /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.BoosterIgnorList.RecyclerTouchListener.AnonymousClass1 */
