...
public class Utils {
    ...
    public static void permissionDialog(final Context context, final int i) {
        ...
        if (i == 1) {
            ...
            imageView2.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.icon_super_ricket));
            textView2.setText(R.string.settingPermission);
        } else {
            textView.setText(R.string.settingPermissionTxt);
            imageView2.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.settings));
            textView2.setText(R.string.settingPermission0);
        }
        imageView.setOnClickListener(new View.OnClickListener() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.Utils.AnonymousClass2 */
        ...
        button.setOnClickListener(new View.OnClickListener() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.Utils.AnonymousClass3 */
