...
public class CoolingActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public BroadcastReceiver batteryInfoReceiver = new BroadcastReceiver() {
        /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass7 */
   ...
   // private DecimalFormat mFormatTime = new DecimalFormat("0.#", this.symbols);
    ...
    final Runnable r2 = new Runnable() {
        /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass10 */
        private int gl;
        ...
        public void run() {
            ...
            while (CoolingActivity.this.TempWheelProgress < 140) {
                ...
                CoolingActivity.this.runOnUiThread(new Runnable() {
                    /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass10.AnonymousClass1 */
    ...
    public void LoadActivityOnCreate() {
        ...
        colorSelection(getResources().getColor(R.color.darkredcolor));
        ...
        new Handler().postDelayed(new Runnable() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass8 */
        ...
        new Handler().postDelayed(new Runnable() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass9 */
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.app_cardsLay:
                startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id=com.protrustedapps.coolmaster.supercooling.phone.cooler")));
                return;
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int i, long j) {
        ...
        builder.setCancelable(true).setPositiveButton(getString(R.string.addToIgnoreList), new DialogInterface.OnClickListener() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass6 */
    ...
    public void functionForShowIgnorListDialog() {
        ...
        ((RelativeLayout) inflate.findViewById(R.id.dialogButton)).setOnClickListener(new View.OnClickListener() {
            /* class com.ptapps.smartbooster.phonecooler.boost.ramcleaner.fast.CoolingActivity.AnonymousClass11 */
